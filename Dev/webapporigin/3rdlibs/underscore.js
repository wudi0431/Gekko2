...
(function () {
  ...
  /**
   * 监听元素上的手势操作
   * @method Global._.flip
   * @param {el} el Zepto/Jquery 节点对象
   * @param {String} dir 手势方向  left/right/up/down
   * @param {Function} fn 事件回调
   * @param {Boolean|function} [noPreventDefault=false] 是否阻止默认动作,可以为boolean,也可以是一个返回boolean的function, 默认为false
   * @param {Number} [sensibility=0] 灵敏度，0|1, 1会耿灵敏
   */
  ...
  /**
   * 取消元素上的手势监听
   * @method Global._.flipDestroy
   * @param {Dom} el zepto/jquery对象
   */
