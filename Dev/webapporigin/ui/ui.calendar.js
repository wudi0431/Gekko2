    ...
    propertys: function ($super) {
      ...
      this.datamodel = {
        ...
        dayItemFn: function (year, month, day, dateObj, difftime) {
          ...
          dayStrArr[0] = '<em>' + dayObj.day + '</em>';
          if (dayObj.day1) {
            dayStrArr[0] = '<em>' + dayObj.day1 + '</em>';
          }

          if (dayObj.solarHoliday) {
            dayStrArr[1] = '<i>' + dayObj.solarHoliday + '</i>';
          }

          if (dayObj.lunarHoliday) {
            dayStrArr[1] = '<i>' + dayObj.lunarHoliday + '</i>';
          }

          dateStr = dateStr + dayStrArr.join('') + '</div>';
